...
# V1 Create Transaction QPS/TPS Test Script
# This script runs a dedicated test for V1 Create Transaction API to measure maximum write QPS/TPS

set -e

echo "=========================================="
echo "V1 Create Transaction QPS/TPS Test"
echo "=========================================="
...
if [ -f "$SCRIPT_DIR/v1-create-test.jmx" ]; then
    # Running from jmeter directory
    TEST_PLAN="$SCRIPT_DIR/v1-create-test.jmx"
...
RESULTS_FILE="$RESULTS_DIR/v1-create-test.jtl"
REPORT_DIR="$RESULTS_DIR/v1-create-test-report"
...
echo "- API: V1 Create Transaction (Traditional Thread)"
echo "- Threads: 3000"
echo "- Loops: 50"
...
echo "Application is running. Starting V1 Create Transaction test..."
echo ""
...
if [ -f "$RESULTS_FILE" ]; then
    echo ""
    echo "=========================================="
    echo "V1 Create Transaction Performance Analysis"
    echo "=========================================="
    ...
    if [ "$TOTAL_REQUESTS" -gt 0 ]; then
        ...
        REPORT_FILE="$RESULTS_DIR/v1-create-test-report.txt"
        cat > "$REPORT_FILE" << EOF
==========================================
V1 Create Transaction Test Report
==========================================
Test Date: $(date)
...
echo ""
echo "V1 Create Transaction test completed successfully!" 