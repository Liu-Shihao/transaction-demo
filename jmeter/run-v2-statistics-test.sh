...
# V2 Statistics QPS Test Script
# This script runs a dedicated test for V2 Statistics API to measure maximum read QPS

set -e

echo "=========================================="
echo "V2 Statistics QPS Test"
echo "=========================================="
...
if [ -f "$SCRIPT_DIR/v2-statistics-test.jmx" ]; then
    # Running from jmeter directory
    TEST_PLAN="$SCRIPT_DIR/v2-statistics-test.jmx"
...
RESULTS_FILE="$RESULTS_DIR/v2-statistics-test.jtl"
REPORT_DIR="$RESULTS_DIR/v2-statistics-test-report"
...
echo "- API: V2 Statistics (Virtual Thread)"
echo "- Threads: 3000"
echo "- Loops: 50"
...
echo "Application is running. Starting V2 Statistics test..."
echo ""
...
if [ -f "$RESULTS_FILE" ]; then
    echo ""
    echo "=========================================="
    echo "V2 Statistics Performance Analysis"
    echo "=========================================="
    ...
    if [ "$TOTAL_REQUESTS" -gt 0 ]; then
        ...
        REPORT_FILE="$RESULTS_DIR/v2-statistics-test-report.txt"
        cat > "$REPORT_FILE" << EOF
==========================================
V2 Statistics Test Report
==========================================
Test Date: $(date)
...
echo ""
echo "V2 Statistics test completed successfully!" 