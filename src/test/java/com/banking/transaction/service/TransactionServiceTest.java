...
import com.banking.transaction.repository.InMemoryTransactionRepository;
...
class TransactionServiceTest {
    ...
    @BeforeEach
    void setUp() {
        transactionService = new TransactionServiceImpl(transactionRepository, cacheService);
